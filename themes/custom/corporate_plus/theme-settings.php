 ...
 * 
 */
function corporate_plus_form_system_theme_settings_alter(array &$form, FormStateInterface $form_state) {
  ...
  $form['visibility'] = [
    '#type' => 'vertical_tabs',
    '#title' => t('Corporate Plus Settings'),
    '#weight' => -999,
  ];
  // General Settings 
  $form['general'] = [
  ...
  $form['general']['portfolio']['pager']['pager_prev_text'] = array(
    '#type'          => 'textfield',
    '#title'         => t('Previous page link text'),
    '#default_value' => theme_get_setting('pager_prev_text'),
  );
  $form['general']['portfolio']['pager']['pager_next_text'] = array(
    '#type'          => 'textfield',
  ...
  $form['general']['login']['login_description'] = array(
    '#type'          => 'textfield',
    '#title'         => t('Description'),
    '#default_value' => theme_get_setting('login_description'),
  );
  ...
  $form['general']['register']['register_description'] = array(
    '#type'          => 'textfield',
    '#title'         => t('Description'),
    '#default_value' => theme_get_setting('register_description'),
  );
  ...
  $form['general']['r_pass']['r_pass_description'] = array(
    '#type'          => 'textfield',
    '#title'         => t('Description'),
    '#default_value' => theme_get_setting('r_pass_description'),
  );
  $form['general']['r_pass']['r_pass_image'] = array(
    '#type' => 'managed_file',
    '#title'         => t('Image'),
    '#default_value' => theme_get_setting('r_pass_image'),
    '#upload_location' => 'public://',
  );
  ...
  $form['general']['maintenance_mode']['comingsoon_description'] = [
    '#type' => 'textarea',
    '#title' => t('Description'),
    '#default_value' => theme_get_setting('comingsoon_description'),
  ];
  ...
  $form['#submit'][] = 'corporate_plus_form_submit';
}
/**
 * Implements hook_form_submit().
 */
function corporate_plus_form_submit(&$form, $form_state) {
